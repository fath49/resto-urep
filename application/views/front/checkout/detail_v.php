                ...
                <div id="post-9" class="post-9 page type-page status-publish hentry">
                    ...
                    <div class="entry-content">
                        <div class="woocommerce">
                            ...
                            <p class="woocommerce-thankyou-order-received">Silahkan Lakukan Konfirmasi Pembayaran Melalui Whatsapp Agar Pesanan Dapat Kami Proses</p>
                            <ul class="woocommerce-thankyou-order-details order_details">
                                <li class="order">No. Order #:<strong><?=$Order->order_id;?></strong></li>
                                <li class="date">Tanggal Order :<strong><?=tgl_indo($Order->order_tanggal);?></strong></li>
                            ...
                            <p><a href="https://wa.me/6281284061613" class="tbl-coklat">>>Konfirmasi Pembayaran<<</a></p>
